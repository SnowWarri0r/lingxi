...
from persona_agent.conversation.adapters import TextAdapter
from persona_agent.conversation.context import ContextAssembler
from persona_agent.conversation.output_schema import TurnOutput, parse_turn_output
from persona_agent.memory.manager import MemoryManager
from persona_agent.persona.models import EmotionState, PersonaConfig
from persona_agent.persona.prompt_builder import PromptBuilder
from persona_agent.planning.executor import ActionExecutor
from persona_agent.planning.planner import Planner
from persona_agent.planning.scheduler import Scheduler
from persona_agent.providers.base import LLMProvider, StreamChunk
from persona_agent.providers.embedding import EmbeddingProvider
from persona_agent.temporal.tracker import InteractionTracker
from persona_agent.temporal.relationship import RelationshipEvaluator
...
class ConversationEngine:
    ...
    async def chat_stream_events(
        ...
        """
        from persona_agent.conversation.output_schema import META_DELIMITER
