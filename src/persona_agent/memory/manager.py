...
from persona_agent.memory.base import EpisodeEntry, MemoryEntry, MemoryStore, MemoryType
from persona_agent.memory.consolidation import MemoryConsolidator
from persona_agent.memory.entity_graph import EntityExtractor, EntityGraph
from persona_agent.memory.episodic import EpisodicMemory
from persona_agent.memory.long_term import LongTermMemory
from persona_agent.memory.short_term import ConversationTurn, ShortTermMemory
...
class MemoryManager:
    ...
    def __init__(
        ...
        if long_term_backend == "chroma":
            from persona_agent.memory.chroma_store import ChromaMemoryStore
        ...
        if long_term_backend == "chroma":
            from persona_agent.memory.chroma_episodic import ChromaEpisodicMemory
