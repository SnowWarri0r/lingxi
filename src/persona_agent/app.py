...
from persona_agent.auth.models import AuthConfig, AuthMethod
...
from persona_agent.utils.logging import setup_logging, get_logger
...
async def create_engine(
    ...
    from persona_agent.providers.embedding import create_embedding_provider
    ...
    from persona_agent.inner_life import (
        AgendaEngine,
        InnerLifeStore,
        SubjectiveLayer,
    )
